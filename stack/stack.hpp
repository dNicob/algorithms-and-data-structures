...
public:
  ...
  // Copy assignment
  Stack<Data>& operator=(const Stack<Data>&) = delete; // Copy assignment of abstract types should not be possible.
  Stack<Data>& operator=(Stack<Data>&&) noexcept = delete; // Move assignment of abstract types should not be possible.
